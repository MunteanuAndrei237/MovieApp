...
const generateTokenThunk = createAsyncThunk(
  "user/generateTokenThunk",
  async () => {
    try {
...
const tryCreateSessionThunk = createAsyncThunk(
  "user/tryCreateSessionThunk",
  async (token) => {
    try {
      const validateSessionUrl =
      ...
      else return validateSessionData.session_id;
    } catch (error) {
...
const fetchUserInformationThunk = createAsyncThunk(
  "user/fetchUserInformationThunk",
  async (sessionId) => {
    try {
